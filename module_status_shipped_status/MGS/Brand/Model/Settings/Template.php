...
class MGS_Brand_Model_Settings_Template {
    ...
    public function toOptionArray() {
        return array(
            ...
            array('value' => '1column-view', 'label' => Mage::helper('adminhtml')->__('1 Column view')),
            array('value' => '2columns-left', 'label' => Mage::helper('adminhtml')->__('2 Columns Left')),
            array('value' => '2columns-left-list', 'label' => Mage::helper('adminhtml')->__('2 Columns Left List')),
